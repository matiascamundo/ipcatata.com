...
<html lang="pt-br">
	<head>
		<meta charset="utf-8">
<title>Cadastrar lista 10ª classe</title>
		<link rel="stylesheet" type="text/css" href="css/estilos.css">		
	</head>
	<body>
		<center><H6>Cadastar lista de presença 10ª classe</H6></center>
		<h2 align="center">Lista de presença 10ª Classe Construção cívil<h2>
...
<legend>Informações Pessoais</legend>
			...
			<input type="text" name="Nºdeprocesso" size="40"placeholder="Digite Nº de processo "class="classe_actual"><br><br>
