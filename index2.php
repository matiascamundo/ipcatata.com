...
<html lang="pt-br">
	<head>
		<meta charset="utf-8">
		<title>Cadastro 12ª Classe</title>
		<link rel="stylesheet" type="text/css" href="css/estilos.css">		
	</head>
	<body>
		<H6 align="center">Matrícula 12ª Classe</H6>
	<center>
	<img src="IMG/IMPC.jpg" width="300" height="250">
</center>
	<center><h1>Instituto Politécnico da Catata nº257<h1></center>

	<h2 align="center">Confirmação de matricula para 12ª Classe<h2>
		...
		?>
		<form method="POST" action="processou.php">
			<fieldset>
<legend>Informações Pessoais</legend>
			...
			<input type="text" name="classe"size="40" placeholder="Digite 12ª classe " class="classe_actual"><br><br>
	...
	<img src="IMG/emis5.jpg" width="150" height="80">
			...
			<center><p class="letra">Forma de pagamento da matricula</p>
