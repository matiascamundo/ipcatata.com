...
//Index
$result_usuario = "INSERT INTO estundante (nome, email, endereco, telefone, classe, curso, lectivo, criado) VALUES ('$nome', '$email', '$endereco', '$telefone', '$classe', '$curso', '$lectivo', NOW())";
