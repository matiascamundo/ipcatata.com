...
<html lang="pt-br">
	<head>
		<meta charset="utf-8">
<title>Cadastrar lista 11ª classe</title>
		<link rel="stylesheet" type="text/css" href="css/estilos.css">		
	</head>
	<body>
		<center><H6>Cadastar lista de presença 11ª classe</H6></center>
		<h2 align="center">Lista de presença 11ª Classe Informática<h2>
		...
		?>
		<form method="POST" action="lista2.php">
			<fieldset>
<legend>Informações Pessoais</legend>
			...
			<input type="text" name="processonumero" size="40"placeholder="Digite Nº de processo "class="classe_actual"><br><br>
