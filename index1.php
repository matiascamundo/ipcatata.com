...
<html lang="pt-br">
	<head>
		<meta charset="utf-8">
		<title>Cadastro para aluno novo</title>
		<link rel="stylesheet" type="text/css" href="css/estilos.css">		
	</head>
	<body>
		<H6 align="center">Confirmação de Matrícula 10ª Classe</H6>
	<center>
	<img src="IMG/IMPC.jpg" width="300" height="250">
</center>
	<center><h1>Instituto Politécnico da Catata nº257<h1></center>

	<h2 align="center">Confirmação para novo aluno<h2>
...
<legend>Informações Pessoais</legend>
			...
			<input type="text" name="classe"size="40" placeholder="Digite 10ª classe" class="classe_actual"><br><br>
