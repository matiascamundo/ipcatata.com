...
<html lang="pt-br">
	<head>
		<meta charset="utf-8">
<title>Cadastrar lista 12ª classe</title>
		<link rel="stylesheet" type="text/css" href="css/estilos.css">		
	</head>
	<body>
		<center><H6>Cadastar lista de presença 12ª classe</H6></center>
		<h2 align="center">Lista de presença 12ª Classe Informática<h2>
		...
		?>
		<form method="POST" action="lista3.php">
			<fieldset>
