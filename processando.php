...
//Index2
$result_usuario = "INSERT INTO estuda (nome, email, endereco, telefone, classe, curso, lectivo, criado) VALUES ('$nome', '$email', '$endereco', '$telefone', '$classe', '$curso', '$lectivo', NOW())";
