...
<html lang="pt-br">
	<head>
		<meta charset="utf-8">
		<title>Mini Pauta 10ª Classe</title>
		<link rel="stylesheet" type="text/css" href="css/estilos.css">		
	</head>
	<body>
		<H6 align="center">Mini-Pauta</H6>
		<h2 align="center">Mini pauta SEAC 10ª Classe Informática<h2>
		...
		?>
		<form method="POST" action="Pauta1.php">
			<fieldset>
